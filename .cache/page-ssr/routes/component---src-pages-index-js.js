...
class IndexPage extends index_js_.Component{componentDidMount(){}constructor(inProps){super(inProps);// Attach state, and determine if the dialog is shown based on whether we have a username in localStorage.
const username=StorageManager/* getName */.oY();console.log(`IndexPage.constructor(): username=${username}`);this.state={dialogVisible:username===null||username==="",username:username};// Capture the data passed in.
this.data=inProps.data;}handleDialogSave(){console.log("handleDialogSave()");// Only react to the button click if they actually entered something.
if(this.state.username!==null&&this.state.username.trim()!==""){console.log(`handleDialogSave(): Saving username=${this.state.username}`);// First things first: close the dialog.
this.setState({dialogVisible:false});// Finally, store the username.
//localStorage.setItem("username", this.state.username);
StorageManager/* setName */.qC(this.state.username);}}render(){const image=R(this.data.divider);console.log(this.data);return/*#__PURE__*/index_js_.createElement(layout/* default */.Z,null,/*#__PURE__*/index_js_.createElement(seo/* default */.Z,{title:"Home"}),/*#__PURE__*/index_js_.createElement("div",{class:"outerContainer"},/*#__PURE__*/index_js_.createElement(Dialog/* default */.Z,{open:this.state.dialogVisible,maxWidth:"sm",fullWidth:true,disableEscapeKeyDown:true},/*#__PURE__*/index_js_.createElement(DialogTitle/* default */.Z,null,"You need a username to use Markdown Board"),/*#__PURE__*/index_js_.createElement(DialogContent/* default */.Z,null,/*#__PURE__*/index_js_.createElement(TextField/* default */.Z,{label:"Enter username here",fullWidth:true,variant:"outlined",required:true,defaultValue:"",onChange:inEvent=>this.setState({username:inEvent.target.value})})),/*#__PURE__*/index_js_.createElement(DialogActions/* default */.Z,null,/*#__PURE__*/index_js_.createElement(Button/* default */.Z,{onClick:this.handleDialogSave.bind(this),color:"primary",variant:"outlined"},"Save"))),/*#__PURE__*/index_js_.createElement("h2",null,this.data.site.siteMetadata.description),/*#__PURE__*/index_js_.createElement("h3",null,this.data.site.siteMetadata.author),/*#__PURE__*/index_js_.createElement(J,{src:"../images/splash.png",height:296,width:420,quality:95,formats:["auto","webp","avif"],alt:"A Gatsby astronaut",style:{marginBottom:`1.45rem`},__imageData:__webpack_require__(9979)}),/*#__PURE__*/index_js_.createElement("br",null),/*#__PURE__*/index_js_.createElement(Y,{image:image,alt:this.data.site.siteMetadata.author}),/*#__PURE__*/index_js_.createElement("br",null),this.data.allMarkdownRemark.edges.map((inItem,inIndex)=>{//noinspection JSUnresolvedVariable
return/*#__PURE__*/index_js_.createElement("div",{key:inIndex,className:"documentDiv"},/*#__PURE__*/index_js_.createElement(gatsby_browser_entry.Link,{to:inItem.node.frontmatter.slug},inItem.node.frontmatter.title));})));}}const pageQuery="281028420";
...
"use strict";
module.exports = JSON.parse('{"layout":"constrained","backgroundColor":"#f8f8f8","images":{"fallback":{"src":"/static/2ddeebb3e21ff525cd7bc7af86c95c4b/04bb5/splash.png","srcSet":"/static/2ddeebb3e21ff525cd7bc7af86c95c4b/997c3/splash.png 74w,\\n/static/2ddeebb3e21ff525cd7bc7af86c95c4b/9f8b8/splash.png 148w,\\n/static/2ddeebb3e21ff525cd7bc7af86c95c4b/04bb5/splash.png 295w","sizes":"(min-width: 295px) 295px, 100vw"},"sources":[{"srcSet":"/static/2ddeebb3e21ff525cd7bc7af86c95c4b/fc65a/splash.avif 74w,\\n/static/2ddeebb3e21ff525cd7bc7af86c95c4b/0488f/splash.avif 148w,\\n/static/2ddeebb3e21ff525cd7bc7af86c95c4b/58e78/splash.avif 295w","type":"image/avif","sizes":"(min-width: 295px) 295px, 100vw"},{"srcSet":"/static/2ddeebb3e21ff525cd7bc7af86c95c4b/03a00/splash.webp 74w,\\n/static/2ddeebb3e21ff525cd7bc7af86c95c4b/3a510/splash.webp 148w,\\n/static/2ddeebb3e21ff525cd7bc7af86c95c4b/4a12a/splash.webp 295w","type":"image/webp","sizes":"(min-width: 295px) 295px, 100vw"}]},"width":420,"height":296.135593220339}');
